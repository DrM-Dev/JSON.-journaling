# JSON Journaling 0.1   -   by  Dr.M-Dev
#=========================================================
from tkinter import *
...
print(f"**** WELCOME to JSON Journaling    -by-    Dr.M-Dev ****")
...
def save_file():
    ...
    global new_data
    ############
    j_entry_name = (j_entry_bar.get()).lower()
...
def recover_entry():
    requested_entry_name = (j_entry_bar.get()).lower()
    # _____________________________
    try:
